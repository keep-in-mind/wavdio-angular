...
@Component({
  selector: 'app-admin-part-image-details',
  templateUrl: './admin-part-image-details.component.html',
  styleUrls: ['./admin-part-image-details.component.css']
})
export class AdminPartImageDetailsComponent implements OnInit {
